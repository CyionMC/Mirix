...
public abstract class BaseComponent
{
     ...
     * this component hasn't been set. false is returned if other of the parent
     * chain has been set.
     *
     ...
     * if this component hasn't been set. false is returned if other of the
     ...
     * setting if this component hasn't been set. false is returned if other of
